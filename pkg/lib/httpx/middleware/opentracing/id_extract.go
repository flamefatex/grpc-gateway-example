...
func injectOpentracingIdsToTags(traceHeaderName string, span opentracing_go.Span, tags grpc_ctxtags.Tags) {
	if err := span.Tracer().Inject(span.Context(), opentracing_go.HTTPHeaders,
